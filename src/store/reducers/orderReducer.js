...
const reducer = (state=initialState,action) =>{
    switch(action.type){
        ...
        //purchase related cases
        case actionTypes.PURCHASE_BURGER_FAIL:  return{...state, loading: false }
        ...
        case actionTypes.FETCH_ORDERS_SUCCESS:  return{...state, orders  : action.orders}
